...
const About = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <p className="font-Averta-Bold text-center text-3xl mt-20">
        The Shield Cleaning.Co Story
      </p>
      <p className="font-Averta-Regular text-center mt-6 max-w-[900px]">
      ...
      <div className="relative w-full h-[500px] mt-[80px]">
        ...
        <div className="flex flex-col absolute inset-0 items-center justify-center">
          ...
          <div className="flex flex-col max-w-[600px] w-full mt-10">
            <p className="font-Averta-Bold text-start text-2xl">
              Working Hours
            </p>
      ...
      <div className="flex flex-col w-full p-32">
        <h2 className="font-Averta-Bold text-center text-3xl mb-16">
          Our Amazing Clients
        </h2>
      ...
      <div className="w-full h-[494px] relative">
        ...
        />
        <div className="flex flex-col absolute inset-0 items-center justify-center">
          <p className="font-Averta-Bold text-center text-5xl max-w-[600px] mb-9">
